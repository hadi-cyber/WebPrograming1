			...
			<div class="container">
				<div class="row">
					<div class="col-md-10 col-md-offset-1 text-center">
						...
						<h1 class="white-text">Beri Saya Masukan</h1>
					...
					<div class="col-md-6">
						<div class="contact-form">
							...
							<form>
								...
								<textarea class="input" name="message" placeholder="Tulis Pesan Anda"></textarea>
								<button class="main-button icon-button pull-right">Kirim</button>
							</form>
						</div>
					</div>
					<!-- /contact form -->
