...
$data_desain = $db->tampil_dataDesain();
?>
<!DOCTYPE html>
       ...
       <!--/. NAV TOP  -->
        ...
        <div id="page-wrapper">
          <div class="header"> 
            ...
            <div id="page-inner"> 
               <a href="input_desain.php" class="btn box-title">Tambah Data</a> 
            <div class="row">
                <div class="col-md-12">
                    <!-- Advanced Tables -->
                    <div class="card">
		...
		<thead>
			...
			<th><center>Nama Desain</center></th>
		...
		<?php 
		$no = 1;
		foreach($data_desain as $row){
			?>
			<tr>
				<td><?php echo $no++; ?></td>
				<td><img src="../../../image/<?php echo $row['foto'] ?>" width="185" height="192"></td>
                <td><?php echo $row['nama_desain']; ?></td>
				<td><?php echo $row['editor']?></td>
                <td><?php echo $row['cdate']; ?></td>
				<td>
					<a href="edit_desain.php?id=<?php echo $row['id']; ?>&action=edit"class="btn btn-primary">Update</a>
					<a href="proses_desain.php?id=<?php echo $row['id']; ?>&action=hapus"class="btn btn-danger">Delete</a>
				</td>
			</tr>
			<?php 
		}
