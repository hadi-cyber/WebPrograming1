                ...
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="../../kelola/admin/tampil.php">Data Admin</a>
                            </li>
                            <li>
                                <a href="../../kelola/desain/tampil_desain.php">Data Desain</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="tampil_log.php">Log Activity</a>
                            </li>
                            <li>
          ...
          <table class="table table-striped table-bordered table-hover" id="dataTables-example">
            ...
            <tbody>
                ...
                <td><?php echo $row['cdate']?></td>
                  <td>
                    <center>
                      <a href="proses_log.php?id=<?php echo $row['id']; ?>&action=hapus"class="btn btn-danger">Delete</a>
                    </center>
                  </td>
                </tr>
                <?php 
